    ...
    public class ZongLaJiTestData : TheoryData<OcrTestInput[]>
    {
        public ZongLaJiTestData()
        {
            Add(new OcrTestInput[]
            {
                ...
                new OcrTestInput("纵拉机", "test_screenshot_1.png", "V011", 385, 259, 40, 11, "0.00"),
                new OcrTestInput("纵拉机", "test_screenshot_1.png", "V012", 437, 259, 40, 11, "0.0"),
                new OcrTestInput("纵拉机", "test_screenshot_1.png", "V013", 663, 202, 45, 11, 1799.0),
                new OcrTestInput("纵拉机", "test_screenshot_1.png", "V014", 712, 202, 45, 11, 1799.0),
                ...
                new OcrTestInput("纵拉机", "test_screenshot_1.png", "V021", 353, 325, 42, 11, 792.2),
                new OcrTestInput("纵拉机", "test_screenshot_1.png", "V022", 405, 325, 42, 11, 792.2),
                ...
                new OcrTestInput("纵拉机", "test_screenshot_1.png", "V026", 383, 377, 42, 11, -7.93),
                new OcrTestInput("纵拉机", "test_screenshot_1.png", "V027", 436, 377, 42, 11, -14.8),
                new OcrTestInput("纵拉机", "test_screenshot_1.png", "V028", 667, 318, 42, 11, 399.9),
                new OcrTestInput("纵拉机", "test_screenshot_1.png", "V029", 722, 318, 42, 11, 399.9),
